  ...
  if (!activeTopicId || activeTopicId === 'logo_analysis') {
    ...
    if (logoInfo.companyName) {
      ...
      if (logoReport) {
        ...
        const stLines = doc.splitTextToSize(logoReport.predictions.shortTerm, pageWidth - 53);
        const mtLines = doc.splitTextToSize(logoReport.predictions.midTerm, pageWidth - 53);
        const ltLines = doc.splitTextToSize(logoReport.predictions.longTerm, pageWidth - 53);
