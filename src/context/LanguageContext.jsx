...
export const translations = {
  en: {
    ...
    rpt: {
      ...
      logoTargetAudience: 'Target Audience',
      logoMarket: 'Target Market',
      logoMarketLocal: 'Local',
      logoMarketRegional: 'Regional',
      logoMarketNational: 'National',
      logoMarketGlobal: 'Global',
      logoBrandStyle: 'Brand Style / Positioning',
      logoBrandStylePremium: 'Premium / Luxury',
      logoBrandStyleMassMarket: 'Mass Market',
      logoBrandStyleSpiritual: 'Spiritual / Occult',
      logoBrandStyleCorporate: 'Corporate / Professional',
      logoBrandStyleModern: 'Modern / Minimalist',
      logoBrandStyleTraditional: 'Traditional / Classic',
      logoBrandStyleBold: 'Bold / High Energy',
      logoMainPromise: 'Main Brand Promise',
      logoTypeLabel: 'Logo Type',
      logoShapeLabel: 'Logo Shape & Structure',
      logoPrimaryColorLabel: 'Primary Color',
      logoSecondaryColorLabel: 'Secondary Color',
      logoTypographyLabel: 'Typography Style',
      logoSymbolismLabel: 'Icon / Symbolism Description',
      logoNotDefined: 'Logo analysis parameters not defined. Enter brand details and logo specifications in Edit mode to generate Logo Analysis.',
  ...
  hi: {
    ...
    rpt: {
      ...
      logoTargetAudience: 'लक्षित दर्शक',
      logoMarket: 'लक्षित बाजार',
      logoMarketLocal: 'स्थानीय',
      logoMarketRegional: 'क्षेत्रीय',
      logoMarketNational: 'राष्ट्रीय',
      logoMarketGlobal: 'वैश्विक',
      logoBrandStyle: 'ब्रांड शैली / स्थिति',
      logoBrandStylePremium: 'प्रीमियम / लक्जरी',
      logoBrandStyleMassMarket: 'मास मार्केट',
      logoBrandStyleSpiritual: 'आध्यात्मिक / गूढ़',
      logoBrandStyleCorporate: 'कॉर्पोरेट / व्यावसायिक',
      logoBrandStyleModern: 'आधुनिक / न्यूनतम',
      logoBrandStyleTraditional: 'पारंपरिक / क्लासिक',
      logoBrandStyleBold: 'बोल्ड / उच्च ऊर्जा',
      logoMainPromise: 'मुख्य ब्रांड वादा',
      logoTypeLabel: 'लोगो प्रकार',
      logoShapeLabel: 'लोगो का आकार और संरचना',
      logoPrimaryColorLabel: 'मुख्य रंग',
      logoSecondaryColorLabel: 'सहायक रंग',
      logoTypographyLabel: 'टाइपोोग्राफी शैली',
      logoSymbolismLabel: 'आइकन / प्रतीकवाद विवरण',
      logoNotDefined: 'लोगो विश्लेषण पैरामीटर परिभाषित नहीं हैं। लोगो विश्लेषण उत्पन्न करने के लिए संपादन मोड में ब्रांड विवरण और लोगो विनिर्देश दर्ज करें।',
